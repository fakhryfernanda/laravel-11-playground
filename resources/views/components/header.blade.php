<header>
    <nav class="bg-white border border-b border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="mx-auto flex flex-wrap justify-between items-center max-w-screen-xl">
